...
<link href="assets/assetsAdmin/vendor/datatables-responsive/dataTables.responsive.css" rel="stylesheet">
        ...
        <div id="page-wrapper">
            ...
            <!-- /.row -->
                ...
                <?php 
                if (isset($vars['notiAdmin'])){
                  if ($vars['notiAdmin'] == 1){
                    ?>
                    <div class="alert alert-warning alert-dismissible">
                      <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                      <strong>Listo!</strong> La notificación ha sido eliminada exitosamente.
                    </div>
                    <?php
                  }
                  if ($vars['notiAdmin'] == 2){
                    ...
                    <div class="alert alert-warning alert-dismissible">
                      <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                      <strong>Listo!</strong> La notificación ha sido aceptada exitosamente.
                    </div>
                    <?php
                  }
                }
                            ...
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <tbody>
                                    ...
                                    <tr class="odd gradeX">
                                        ...
                                        <td>
                                          <form action="?controlador=Recinto&accion=eliminarNotificacion" method="post">
...
function carga_ajax(div, id, tipo){
  ...
  if (tipo == 'editar'){
    $.post(
      '?controlador=Recinto&accion=activarNotificacion&idRecinto='+id,
      function(resp){
        $("#"+div+"").html(resp);
      }
      ); 
